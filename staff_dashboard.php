...
<head>
    <meta charset="UTF-8">
    <title>ฝ่ายจัดการคณะ | Internships System</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
  <div class="container">
    <a class="navbar-brand fw-bold" href="index.php">Internships (Staff Dashboard)</a>
    <div class="d-flex">
...
<div class="container mt-5">
    <h2 class="mb-4 text-dark fw-bold border-bottom pb-2">รายการขอฝึกงานของนิสิตทั้งหมด</h2>
                        ...
                        <?php if($result->num_rows > 0): ?>
                            <?php while($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="staff_view.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary">ดูรายละเอียด</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
